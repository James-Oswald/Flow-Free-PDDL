...
if __name__ == "__main__":
    with open("flowproblem3x1.pddl", "w") as file:
        file.write(problemGen(3, 1, {
            "red": ((0,0), (2, 0)),
        }))
    
    with open("flowproblem5x5.pddl", "w") as file:
    ...
    with open("flowproblem6x6.pddl", "w") as file:
        file.write(problemGen(8, 8, {
            "orange": ((1, 1),(7,5)),
            "yellow": ((0,7), (3, 4)),
            "blue" : ((4,5), (7, 7)),
            "green": ((7,4), (7,6)),
    ...
    with open("flowproblem8x8.pddl", "w") as file:
        file.write(problemGen(8, 8, {
            "orange": ((1, 1),(7,5)),
            "yellow": ((0,7), (3, 4)),
            "blue" : ((4,5), (7, 7)),
    ...
    with open("flowproblem15x18.pddl", "w") as file:
